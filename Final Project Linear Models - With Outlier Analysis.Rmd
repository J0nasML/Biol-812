...
autoplot(moistfit2, c(1,2,3,6))#Definitely an outlier cook's distance is well over 200. There is something wrong there. 
...
#Site was only significant predictor of shrub volume:

volfitmoistandtemp<-lm(moistandtempdatanoout$Volume~moistandtempdatanoout$site)
...
#Interaction plot of shrub volume by site and treatment
#Interaction plot of shrub volume by site and soil moisture
