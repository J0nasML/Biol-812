...
q
#Last attempt
cuyama4 <- cuyama %>%mutate(day = day(Date),Date=format(Date,format="%b-%y")) %>% group_by(Date,day,hour,treatment) %>% summarize(Temp=mean(na.omit(Temp)))
#cuyama4<-cuyama4 %>% mutate(Date2=factor(Date,levels=c("16-Feb", "16-Mar","16-Apr","16-May","16-Jun","16-Jul",
    #                                "16-Aug","16-Sep","16-Oct","16-Nov","16-Dec",
   #                                 "17-Jan","17-Feb","17-Mar","17-Apr")))

#cuyama4$Date<-factor(cuyama4$Date, levels=c("16-Feb", "16-Mar","16-Apr","16-May","16-Jun","16-Jul",
 #                                   "16-Aug","16-Sep","16-Oct","16-Nov","16-Dec",
  #                                  "17-Jan","17-Feb","17-Mar","17-Apr"))

z<-ggplot(cuyama4,aes(day,hour,fill=Temp))+
  geom_tile(colour="white", size=0.000001) + 
  scale_fill_viridis(name="Hourly Air Temperature C",option ="C",discrete="FALSE")+ 
